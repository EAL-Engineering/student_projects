# Phase 2, Step 5: Compute Node Registration

* **File:** `2.5-node-registration.md`
...
With the VNFS image built (Step 2.3) and the Network Overlays configured (Step 2.4), we must now register the actual hardware.
...
* The aggregated `-P 4` (parallel streams) result should approach **18–19 Gbps**.
