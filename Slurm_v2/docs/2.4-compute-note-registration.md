...
| :--- | :--- | :--- | :--- | :--- |
| **node02** | Compute | 10.0.0.92 | `AC:1F:6B:C4:C4:66` | Node B (Top Left) |
| **node03** | Compute | 10.0.0.93 | `AC:1F:6B:59:A0:B6` | Node C (Bottom Right) |
| **node04** | Compute | 10.0.0.94 | `AC:1F:6B:5A:BD:04` | Node D (Top Right) |
...
You can simply plug a monitor and keyboard into the VGA port on the specific node chassis (Node B/Top Left) to view the output directly.
